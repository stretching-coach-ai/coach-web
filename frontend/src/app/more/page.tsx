...
import { LogOut, User, Settings, Info, Heart, Shield, HelpCircle } from 'lucide-react';
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  <div className="flex items-center">
                    <Shield className="w-5 h-5 text-[#6B925C] mr-3" />
                    <span className={`${Stardust.className}`}>개인정보 처리방침</span>
                  </div>
                  <span className="text-gray-400">›</span>
                </button>
              </li>
          ...
          {user && (
            <div className="pt-4">
              ...
              >
                ...
                <span className={`${Stardust.className} text-red-500`}>로그아웃</span>
              </button>
            </div>
          )}
        </div>
